      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-[#f5eee6] via-[#faf6f0] to-[#fcfbf9] pt-12 pb-20 border-b border-stone-200/80">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-8 relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto pt-4">
            <div className="flex items-center gap-3 p-4 rounded-2xl bg-white/80 backdrop-blur-xs border border-[#e8ded1] shadow-xs hover:shadow-md transition-shadow">
                ...
                <div className="w-full lg:w-1/2">
                  <div className="relative group rounded-3xl overflow-hidden bg-[#f0e8dc] border border-[#e4d6c4] shadow-xl hover:shadow-2xl transition-all duration-500">
                    ...
                    <button
                      ...
                      className="absolute bottom-4 right-4 z-20 flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-stone-950/80 hover:bg-emerald-700 text-white text-xs font-bold backdrop-blur-md border border-white/20 shadow-lg transition-all duration-200 hover:scale-105"
                    >
                ...
                <div className="w-full lg:w-1/2 space-y-6">
                  ...
                  <div className="space-y-3 pt-2">
                    ...
                    <div className="space-y-2.5">
                      {section.process.map(item => (
                        <div
                          key={item.step}
                          className="group/step flex items-start gap-3.5 p-3 rounded-2xl bg-white border border-[#eae0d2] hover:border-emerald-600 hover:shadow-md transition-all duration-300"
                        >
                  ...
                  <div className="pt-3 flex items-center gap-3">
                    <button
                      ...
                      className="inline-flex items-center gap-2 rounded-xl bg-stone-900 hover:bg-emerald-700 text-white px-5 py-2.5 text-xs font-extrabold uppercase tracking-wider shadow-md hover:shadow-lg transition-all duration-200 hover:scale-105"
                    >
      ...
      <section className="bg-gradient-to-b from-[#f5eee6] to-[#fcfbf9] py-16 border-y border-stone-200/80">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 border border-[#e8ded1] shadow-sm hover:shadow-xl transition-all space-y-4">
