            ...
            return (
              ...
              >
                <div className="space-y-4">
                  <div className="h-12 w-12 rounded-xl bg-lime-100 text-lime-950 flex items-center justify-center group-hover:bg-[#65a30d] group-hover:text-white transition-colors shadow-xs">
                    <IconComponent className="h-6 w-6" />
                  </div>
                  <div>
                    <h3 className="font-serif text-base font-extrabold text-black group-hover:text-[#65a30d] transition-colors">
                      {cat.name}
                    </h3>
