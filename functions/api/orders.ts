...
export const onRequestPost: PagesFunction<Env> = async (context) => {
  try {
    const { buyer_id, buyer_name, buyer_email, buyer_phone, buyer_company, buyer_country, items, total_cartons, total_cbm, total_gw } = await context.request.json() as any;
